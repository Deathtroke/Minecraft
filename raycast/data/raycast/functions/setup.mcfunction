scoreboard objectives add raycast minecraft.used:minecraft.carrot_on_a_stick
scoreboard objectives add reyspeed dummy
scoreboard objectives add cooldown dummy
scoreboard objectives add cooldown2 dummy
scoreboard objectives add cd dummy
scoreboard objectives add maxcooldown dummy
scoreboard objectives add RocketLouncher dummy
...
scoreboard objectives add inteam dummy
scoreboard objectives add random dummy
scoreboard objectives add randomSpawn dummy
scoreboard objectives add DidSpawn dummy
