...
execute if entity @e[tag=!Revolver,distance=..1] run effect give @e[tag=!Revolver,distance=..1] minecraft:instant_damage 1 1 true
execute if entity @e[tag=!Revolver,distance=..1] run kill @s
...
execute positioned ^ ^-1 ^ if entity @e[tag=!Revolver,distance=..1] run effect give @e[tag=!Revolver,distance=..1] minecraft:instant_damage 1 2 true
