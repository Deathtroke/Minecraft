...
#/give @a[scores={class=1}] minecraft:carrot_on_a_stick{display:{Name:"{\"text\":\"Revolver\"}"},Unbreakable:1b,Damage:11} 1
#/give @a[scores={class=1}] minecraft:carrot_on_a_stick{display:{Name:"{\"text\":\"MP\"}"},Unbreakable:1b,Damage:12} 1
